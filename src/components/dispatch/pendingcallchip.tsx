...
const ALARM_THRESHOLD_SECONDS = 120;
...
/** The chip shown in place of a team before any team is assigned to a call. Ticks a live mm:ss timer and, once pending 2+ minutes, blinks between grey and the status-alarm orange until a team is assigned. */
