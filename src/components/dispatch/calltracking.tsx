              ...
              {[
                ...
                <React.Fragment key={call.id}>
                  {(() => {
                    ...
                    return (
                  <tr
                    className={`cursor-pointer min-h-3.25rem bg-transparent rounded-none ${hoverClass} transition-colors ${isResolvedCall && !isMotionVisible ? '[&>td]:!border-b-0 pointer-events-none' : ''}`}
